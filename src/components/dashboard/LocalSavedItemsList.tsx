...
import { localStorageUtils, LocalSavedItem } from '@/lib/localStorage'
...
export function LocalSavedItemsList() {
  ...
  const deleteItem = (id: string) => {
    try {
      const success = localStorageUtils.deleteItem(id)
      if (success) {
  ...
  const toggleFavorite = (id: string) => {
    try {
      const success = localStorageUtils.toggleFavorite(id)
      if (success) {
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-700 mt-1">
              Your saved items are stored locally in your browser. They will be lost if you clear your browser data.
            </p>
          </div>
        </div>
      </div>
